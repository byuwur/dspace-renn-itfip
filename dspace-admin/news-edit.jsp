...
<dspace:layout style="submission" titlekey="jsp.dspace-admin.news-edit.title"
    ...
    <%-- <h1>News Editor</h1> --%>
    <center>
    <h1><strong><fmt:message key="jsp.dspace-admin.news-edit.heading"/></strong></h1>
    </center>
...
<center>
        ...
        <%-- <input type="submit" name="cancel" value="Cancel"> --%>
		    <input class="btn btn-danger" type="submit" name="cancel" value="<fmt:message key="jsp.dspace-admin.general.cancel"/>" />
