...
<div class="container">
    <div class="panel panel-primary">
        <div class="panel-heading">
             <center><h2><strong>&nbsp;&nbsp;<fmt:message key="jsp.register.edit-profile.title"/></strong></h2></center>
        </div>         
...
%>
    ...
    <p class="alert alert-danger"><fmt:message key="jsp.register.edit-profile.info1"/></p>
<%
    }
...
%>
    ...
    <p class="alert alert-danger"><fmt:message key="jsp.register.edit-profile.info2"/></p>
<%
    }
%>
